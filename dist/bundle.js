...
.projects-list > li {
  ...
  margin-bottom: 1rem;
  position: relative;
  -webkit-box-shadow: 0px 2px 25px -10px rgba(0, 0, 0, 0.3);
  -moz-box-shadow: 0px 2px 25px -10px rgba(0, 0, 0, 0.3);
  box-shadow: 0px 2px 25px -10px rgba(0, 0, 0, 0.3);
}
...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,kBAAkB;EAClB,SAAS;EACT,uBAAuB;AACzB;;AAEA;;EAEE;iDAC+C;AACjD;;AAEA;;;EAGE,eAAe;AACjB;;AAEA;EACE,iBAAiB;EACjB,SAAS;EACT,oBAAoB;EACpB,kBAAkB;EAClB,YAAY;EACZ,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,OAAO;AACT;;AAEA;;;EAGE,aAAa;AACf;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;;EAEE,yBAAyB;EACzB,YAAY;AACd;;AAEA;EACE,oCAAoC;EACpC,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,UAAU;EACV,SAAS;EACT,qBAAqB;AACvB;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,kBAAkB;EAClB,yDAAyD;EACzD,sDAAsD;EACtD,iDAAiD;AACnD;;AAEA;EACE,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,iBAAiB;EACjB,qBAAqB;AACvB;;AAEA;EACE,6BAA6B;EAC7B,eAAe;EACf,0BAA0B;AAC5B;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,6BAA6B;EAC7B,iBAAiB;AACnB;;AAEA;EACE,OAAO;AACT;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,WAAW;EACX,WAAW;EACX,qBAAqB;EACrB,uBAAuB;EACvB,kBAAkB;AACpB;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,eAAe;EACf,WAAW;EACX,cAAc;EACd,8BAA8B;EAC9B,0BAA0B;EAC1B,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;AACrB;AACA;EACE,iBAAiB;EACjB,UAAU;EACV,gBAAgB;EAChB,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,iBAAiB;AACnB;;AAEA;EACE,cAAc;EACd,kBAAkB;EAClB,SAAS;EACT,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,uBAAuB;EACvB,iBAAiB;EACjB,YAAY;AACd;;AAEA;;;;EAIE,mBAAmB;EACnB,WAAW;EACX,gBAAgB;EAChB,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA;EACE;IACE,gBAAgB;IAChB,YAAY;EACd;AACF","sourcesContent":["* {\n  box-sizing: border-box;\n  font-size: 16px;\n}\n\nbody {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  min-height: 100dvh;\n  margin: 0;\n  background-color: wheat;\n}\n\nbody,\nbutton {\n  font-family: \"HelveticaNeue-Light\", \"Helvetica Neue Light\", \"Helvetica Neue\",\n    Helvetica, Arial, \"Lucida Grande\", sans-serif;\n}\n\nselect,\ninput[type=\"text\"],\ntextarea {\n  font-size: 16px;\n}\n\nbutton {\n  background: coral;\n  border: 0;\n  padding: 0.5rem 1rem;\n  border-radius: 5px;\n  color: white;\n  font-weight: bold;\n  cursor: pointer;\n}\n\n#container {\n  flex: 1;\n}\n\n#container,\nfooter,\nheader {\n  padding: 1rem;\n}\n\nheader {\n  font-weight: bold;\n}\n\nfooter {\n  text-align: center;\n}\n\nfooter,\nheader {\n  background-color: #111111;\n  color: white;\n}\n\n.actions {\n  background: rgba(255, 255, 255, 0.5);\n  padding: 1rem;\n  margin-bottom: 1rem;\n  border-radius: 10px;\n  text-align: center;\n}\n\n.projects-list {\n  padding: 0;\n  margin: 0;\n  list-style-type: none;\n}\n\n.projects-list > li {\n  background: white;\n  padding: 1rem;\n  border-radius: 10px;\n  margin-bottom: 1rem;\n  position: relative;\n  -webkit-box-shadow: 0px 2px 25px -10px rgba(0, 0, 0, 0.3);\n  -moz-box-shadow: 0px 2px 25px -10px rgba(0, 0, 0, 0.3);\n  box-shadow: 0px 2px 25px -10px rgba(0, 0, 0, 0.3);\n}\n\n.project-title {\n  font-weight: bold;\n  font-size: 1.1rem;\n}\n\n.projects-list .delete-project {\n  position: absolute;\n  top: 1.2rem;\n  right: 0.6rem;\n  cursor: pointer;\n}\n\n.tasks-list {\n  padding: 0.5rem 0;\n  list-style-type: none;\n}\n\n.tasks-list > li {\n  border-bottom: 1px solid #ccc;\n  padding: 1rem 0;\n  text-transform: capitalize;\n}\n\n.tasks-list > li:last-child {\n  border-bottom: 0;\n}\n\n.task {\n  display: flex;\n  justify-content: space-between;\n  border-bottom: 1px solid #ccc;\n  padding: 0.5rem 0;\n}\n\n.task div:first-child {\n  flex: 1;\n}\n\n.task > div {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\n.task-description {\n  font-weight: bold;\n}\n\n[class*=\"task-priority\"] {\n  width: 20px;\n  height: 8px;\n  display: inline-block;\n  background-color: black;\n  margin-right: 10px;\n}\n\n.task-priority-high {\n  background-color: red;\n}\n\n.task-priority-medium {\n  background-color: orange;\n}\n\n.task-priority-low {\n  background-color: green;\n}\n\n.modal {\n  position: fixed;\n  width: 100%;\n  height: 100dvh;\n  background: rgba(0, 0, 0, 0.5);\n  backdrop-filter: blur(2px);\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.modal-content {\n  background: white;\n  width: 90%;\n  max-width: 30rem;\n  margin: auto;\n  padding: 1rem;\n  border-radius: 10px;\n  position: relative;\n}\n\n.modal-content h2 {\n  margin-top: 0;\n  font-size: 1.2rem;\n}\n\n.modal-close {\n  display: block;\n  position: absolute;\n  top: 1rem;\n  right: 0.5rem;\n  cursor: pointer;\n}\n\n.new-task-button {\n  background: transparent;\n  padding: 0.5rem 0;\n  color: black;\n}\n\nform input[type=\"text\"],\nform input[type=\"date\"],\nform select,\nform textarea {\n  margin-bottom: 1rem;\n  width: 100%;\n  padding: 0.75rem;\n  border: 1px solid #999;\n  border-radius: 5px;\n}\n\n@media screen and (min-width: 800px) {\n  .projects-container {\n    max-width: 800px;\n    margin: auto;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ renderDefaultContent)
/* harmony export */ });
...
function renderDefaultContent() {
  if (localStorage.getItem("projects") === null) {
    ...
    let project = (0,_projects__WEBPACK_IMPORTED_MODULE_0__.createProject)(projectName);
    (0,_tasks__WEBPACK_IMPORTED_MODULE_1__.createTask)(project, taskName, taskDescription, taskDueDate, taskPriority);
  }
}
...
/* harmony import */ var _renderModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./renderModal */ "./src/renderModal.js");
...
function newProjectButton() {
  ...
  button.addEventListener("click", () => {
    ...
    (0,_renderModal__WEBPACK_IMPORTED_MODULE_2__["default"])(newProjectForm()); //expects node element
  });
...
function projectsList() {
  ...
  if (projects) {
    ...
    projects.forEach((project) => {
      ...
      const tasks = (0,_renderTasks__WEBPACK_IMPORTED_MODULE_1__.renderTasks)(project.id);
...
/* harmony import */ var _renderModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderModal */ "./src/renderModal.js");
...
function newTaskButton(projectID) {
  ...
  button.addEventListener("click", () => {
    // open the new project form in a modal
    (0,_renderModal__WEBPACK_IMPORTED_MODULE_1__["default"])(newTaskForm(projectID)); //expects node element
  });
...
function editTask(taskID) {
  ...
  document.querySelector(".modal").remove();
  //open edit form
  (0,_renderModal__WEBPACK_IMPORTED_MODULE_1__["default"])(taskEdit);
}

function viewTask(taskID) {
  //create a function in tasks.js to return a task
  const task = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.readTask)(taskID);
  ...
  (0,_renderModal__WEBPACK_IMPORTED_MODULE_1__["default"])(taskView);
}
...
function tasksList(projectID) {
  const tasks = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.readTasks)(projectID);
  ...
  tasks.forEach((task) => {
    ...
    const taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(task.dueDate), "Mo MMM");
    ...
    deleteTaskButton.addEventListener("click", () => {
      (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(task.id);
      removeTask(task.id);
    });
...
/* harmony import */ var _renderDefaultContent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderDefaultContent */ "./src/renderDefaultContent.js");
...
function init() {
  ...
  (0,_renderDefaultContent__WEBPACK_IMPORTED_MODULE_1__["default"])();
